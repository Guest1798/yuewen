        ...
        return (<View>
            ...
            <ImageBackground source={require('../../media/2.jpg')} style={{ width: '100%', height: '100%' }}>
                <View style={{ height: '100%', width: '100%', backgroundColor: 'rgba(0,0,0,0.2)' }}>
                    <View><Text style={{ fontSize: 40, fontFamily: 'verdana', color: '#fff', marginLeft: '40%', marginTop: '28%' }}>登录</Text></View>
                    <View style={styles.contain}>
                        ...
                        <View style={{ marginTop: 80, }}>
                            <Button rounded light iconLeft>

                                <Text style={{ fontSize: 16, marginLeft: '44%' }}>登 陆</Text>
                                <Icon name='log-in' style={{ marginLeft: '10%' }} />
                            </Button>
                        </View>
